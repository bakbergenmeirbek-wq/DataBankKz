    ...
    btn.addEventListener('click', async () => {
      ...
      try {
        const text = await window['Data.kz'].callAnthropic(
          [{ role: 'user', content: document.getElementById('jackson-input')?.value?.trim() || 'Банктер туралы жалпы талдау жасаңыз.' }],
          SYSTEM_INSIGHT
        );
